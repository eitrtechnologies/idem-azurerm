...
async def diff(hub, current_dict, past_dict):
...
async def deep_diff(hub, old, new, ignore=None):
    ignore = ignore or []
    res = {}
...
async def recursive_diff(hub, past_dict, current_dict, ignore_missing_keys=True):
    """
