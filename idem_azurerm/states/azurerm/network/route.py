...
async def present(
    ...
    **kwargs,
    ...
    :param route_table: The name of the existing route table which will contain the route.
...
async def absent(
    ...
    :param route_table: The name of the existing route table containing the route.
