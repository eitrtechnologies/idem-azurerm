...
def parse():
    ...
    parser.add_argument("name", help="The name of the script to build from the run.py")
...
class Builder:
    ...
    def report(self):
        ...
        print(
            "To create a more portable and fully static binary install run staticx against your new build"
        )
